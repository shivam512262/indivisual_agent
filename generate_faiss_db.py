    ...
    def generate_medical_knowledge_base(output_dir="."):
        ...
        # In a real-world scenario, you would load this from files (e.g., medical articles, textbooks, clinical notes)
        # For demonstration, we'll use a small sample text.
        sample_medical_text = """
        ...
        **Urinary Tract Infection (UTI)**
        ...
        # Simple splitting by double newline for paragraphs. More sophisticated chunking might be needed for larger texts.
        ...
        # We'll use an IndexFlatL2 for simplicity (Euclidean distance)
        ...
        print("\nFAISS index and text chunks generated successfully!")
        print("You can now run your main application.")

    if __name__ == "__main__":
        # Call the function to generate the knowledge base files
